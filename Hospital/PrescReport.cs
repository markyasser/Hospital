...
namespace Hospital
{
    public partial class PrescReport : Form
    {
        ...
        public PrescReport(int pid, int did, string date)
        {
            InitializeComponent();
            ...
            this.PrescCrystalReport1.SetDataSource(prescription_DataSet1);
            this.crystalReportViewer1.RefreshReport();
        }

        private void PrescReport_Load(object sender, EventArgs e)
        {
